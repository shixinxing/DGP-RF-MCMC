...
class DgpRff(object):
    ...
    def learn(self, data, learning_rate, mc_train, batch_size, n_iterations, optimizer = None, display_step=100,
              test = None, mc_test=None, loss_function=None, duration = 1000000, less_prints=False):
        total_train_time = 0
        ...
        return - nll_test / len(test.Y), loss_function.eval(test.Y, pred)
